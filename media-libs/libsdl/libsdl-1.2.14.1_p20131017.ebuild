...
EAPI=2
inherit autotools flag-o-matic multilib toolchain-funcs eutils libtool

DESCRIPTION="Simple Direct Media Layer (Notaz Edition)"
...
src_prepare() {
	epatch \
		...
		"${FILESDIR}"/${PN}-1.2.14-click.patch \
		"${FILESDIR}"/${PN}-1.2.14-glibc213.patch

		#"${FILESDIR}"/${PN}-1.2.14-joystick.patch \
	cp "${FILESDIR}/sdl.m4" "${S}"
